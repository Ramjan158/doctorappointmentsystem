                        ...
                        <ul class="dropdown-menu message-dropdown">
                                ...
                                <a href="#">
                                    <div class="media">
                                        <span class="pull-left">
                                            <img class="media-object" src="asset/img/2.jpg" alt="">
                                        </span>
                            ...
                            <li class="message-preview">
                                <a href="#">
                                    <div class="media">
                                        <span class="pull-left">
                                            <img class="media-object" src="assets\img\Logo 1.jpg" alt="">
                                        </span>
                                        <div class="media-body">
                                            <h5 class="media-heading">
                                            <strong><?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?></strong>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="C:\xampp\htdocs\doctorappointmentsystem\assets\img" class="img-circle img-responsive"> </div>
